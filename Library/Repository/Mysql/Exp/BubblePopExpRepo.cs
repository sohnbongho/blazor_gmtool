...
public class BubblePopExpRepo : IGameModeExpRepo, IRewardableExp
{
    public GameModeExpType GameModeExpType { get; set; } = GameModeExpType.BubblePop;
    private readonly IGameModeExpSharedRepo _expCommonRepo;
    public static BubblePopExpRepo Of(IGameModeExpSharedRepo expCommonRepo)
    {
        return new BubblePopExpRepo(expCommonRepo);
    }
    private BubblePopExpRepo(IGameModeExpSharedRepo expCommonRepo)
    {
