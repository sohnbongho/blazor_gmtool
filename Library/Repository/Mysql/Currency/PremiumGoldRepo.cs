...
public class PremiumGoldRepo : ICurrencyRepo, IPayableCurrency
{
    public CurrencyType CurrencyType { get; } = CurrencyType.PremiumGold;
    ...
    public static PremiumGoldRepo Of() => new PremiumGoldRepo();
    private PremiumGoldRepo()
    {        
    }
    ...
    {
        return _currency.Increase(db, transaction, reason, userSeq, CurrencyType, itemPrice, ConstInfo.MaxPremiumMoney);
    }
    ...
    {
        return _currency.IncreaseAsync(db, transaction, reason, userSeq, CurrencyType, itemPrice, ConstInfo.MaxPremiumMoney);
    }
